    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:15px;">
        <div style="display:flex; gap:10px;">
            <a href="{{ route('admin.petugas.create') }}" class="add-button" title="Tambah Petugas">
                <span>+</span>
            </a>
            <a href="{{ route('admin.petugas.bulk_upload') }}" class="add-button" title="Import Excel"
    ...
    <div class="table-responsive">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <a href="#" class="btn-action btn-edit" title="Reset Password"><i class="fas fa-sync-alt"></i></a>
                <a href="{{ route('admin.petugas.edit',$p) }}" class="btn-action btn-edit"><i class="fas fa-pencil-alt"></i></a>
                <a href="#" title="Hapus" style="color: #d00;"onclick="event.preventDefault(); if(confirm('Yakin hapus?')) document.getElementById('delete-form-{{ $p->id }}').submit();">
                    <i class="fas fa-trash"></i>
                </a>

                <form id="delete-form-{{ $p->id }}" action="{{ route('admin.petugas.destroy', $p) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
                </form>
