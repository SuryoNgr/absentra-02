...
@section('title', 'Absentra - Upload From Excel')

@section('content')
<div class="bulk-upload-wrapper">

    <a href="{{ route('admin.client.template') }}" class="template-button">
    ...
    <div class="upload-container">
        ...
        <form action="{{ route('admin.client.import') }}" method="POST" enctype="multipart/form-data" class="upload-form">
            @csrf
