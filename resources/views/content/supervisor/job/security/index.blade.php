...
@section('title', 'Job security Services')
...
<div class="manage-job-container">
    <h2>Daftar Pekerjaan Security Services</h2>
  <div class="filter-actions-row">
    <!-- Tombol tambah -->
    <a href="{{ route('supervisor.job.security.create') }}" class="add-button" title="Tambah Job">+</a>

    <!-- Filter dropdown -->
    <form method="GET" action="{{ route('supervisor.job.security.index') }}" class="filter-form">
                ...
                @forelse($jobs as $job)
                    <tr>
                        ...
                        <td class="job-actions">
                            <a href="{{ route('supervisor.job.security.show', $job->id) }}"><i class="fas fa-eye" title="Detail"></i></a>
                            <a href="{{ route('supervisor.job.security.edit', $job->id) }}"><i class="fas fa-edit" title="Edit"></i></a>
                            <a href="{{ route('supervisor.job.security.disbandTeam', ['team' => $job->nama_tim]) }}"onclick="return confirm('Yakin ingin membubarkan tim ini?')" class="disband-link" title="Bubarkan Tim">
